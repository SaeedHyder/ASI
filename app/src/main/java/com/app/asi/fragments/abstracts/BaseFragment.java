package com.app.asi.fragments.abstracts;
...
public abstract class BaseFragment extends Fragment implements webServiceResponseLisener {
    ...
    public void openGuestDialoge(){
        DialogHelper dialogHelper=new DialogHelper(getDockActivity());
        dialogHelper.initDialoge(new View.OnClickListener() {
            @Override
        ...
        },getResString(R.string.access_denied),getResString(R.string.guest_user_error),getResString(R.string.sign_in),getResString(R.string.cancel));
